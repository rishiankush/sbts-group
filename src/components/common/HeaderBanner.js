				...
				<div className="container">
					<div className="main-wrapper">
						...
						<ul className="button-group lightgallery">
							<li><a href="#" className="more-button solid-button-one wow fadeInLeft animated" data-wow-delay="1.5s">More About us <i className="fa fa-angle-right icon-right" aria-hidden="true"></i></a></li>

							<li><a data-fancybox href="#" className="fancybox video-button-one wow fadeInRight animated" data-wow-delay="1.5s">See live demo. <i class="flaticon-play-button icon-right"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
